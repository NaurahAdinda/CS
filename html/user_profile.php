...
<html lang="en">
  ...
  <?php if (isset($_SESSION["user"])) {
    ...
    $DoB = $user["birth_date"];
    $lastEdu = $user["last_education"];
    $email = $user["email"];
    $address = $user["address"];
    $number = $user["phone_number"];

    // Melakukan tindakan lain dengan data user
    // ...
  } else {
  ...
  <body class="home">
    ...
    <div class="main-content">
      <div class="profile-menu">
        ...
        >
        <a class="my-experience"
          ><button class="btn-sec">My Experience</button></a
        >
        <a class="my-education"
          ><button class="btn-sec">My Education</button></a
        >
        <a class="my-skill"
          ><button class="btn-sec">My Skill</button></a
        >
        <a class="my-application"
          ><button class="btn-sec">My Application</button></a
        >
        <a class="logout"
         ...
         <img src="Assets/img/profile.jpg" alt="" class="profile" />
          <div class="detail-info">
            ...
            <div class="self-bio">
              ...
              possimus totam enim doloribus consequuntur atque nobis mollitia
              placeat, dolor magnam repellendus veniam commodi. Sapiente ex
              magnam veritatis ipsam eaque illo.
            </div>
          </div>
        ...
        <div class="personal-information">
            ...
            <div class="info">
                <div class="info-1">
                    ...
                    <p class="text-desc"><?php echo $fullname; ?></p>
                </div>
                <div class="info-1">
                ...
                <div class="info-1">
                    ...
                    <p class="text-desc"><?php echo $DoB; ?></p>
                </div>
                <div class="info-1">
                ...
                <div class="info-1">
                    <p class="title-2">Passion : </p>
                    <p class="title-2"> 1 = IT | 2 = Marketing | 3 = Administrator</p>
                    <p class="text-desc"><?php echo $lastEdu; ?></p>
                </div>
            </div>
        ...
        <div class="personal-information-edit">
            <form class="form" action="" method="post">
                ...
                <div class="info">
                    <div class="info-1">
                        <p class="title-2">Fullname</p>
                        <input name="fullname" class="text-desc" value="<?php echo $fullname; ?>" type="text"></p>
                    </div>
                    <div class="info-1">
                        <p class="title-2">Phone Number</p>
                    ...
                    <div class="info-1">
                        <p class="title-2">Date of Birth</p>
                        <input name="dob" class="text-desc" value="<?php echo $DoB; ?>" type="date"></p>
                    </div>
                    <div class="info-1">
                        <p class="title-2">Address</p>
                    ...
                    <div class="info-1">
                        <p class="title-2">Last Education</p>
                        <input name="last-edu" class="text-desc" value="<?php echo $lastEdu; ?>" type="text"></p>
                    </div>
                </div>
                <button id="save" name="submit-update" class="btn btn-success" type="submit">Save</button>
            </form>
